...
input_filename = joinpath(results_folder, "spectral_gaps_convergence_eraes_main.csv")
...
try
    ...
    output_plot_filename = joinpath(results_folder, "spectral_gaps_convergence_eraes_main.png")
